...
function buildSystemPrompt(): string {
  return [
    ...
    "- browser_evaluate: VERY restricted. NEVER use it to set form values, type into inputs, set <input type=date>, click hidden elements, or otherwise bypass the UI. Use it AT MOST ONCE per goal, and only to READ data the snapshot doesn't show (e.g. compute a count). If you catch yourself thinking 'I'll just inject the value', stop and use the actual UI instead.",
